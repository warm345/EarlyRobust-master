...
if __name__ == "__main__":
    ...
    if scheduled:
        ...
        file_paths = {
            ...
            "mindspore Single GPU": {
                "common": "run_all_tests_mindspore_gpu_test_reports/tests_mindspore_gpu_[].txt",
                "pipeline": "run_all_tests_mindspore_gpu_test_reports/tests_mindspore_pipeline_gpu_[].txt",
                "examples": "run_all_tests_mindspore_gpu_test_reports/examples_mindspore_gpu_[].txt",
            },
            "TF Multi GPU": {
            ...
            "mindspore Multi GPU": {
                "common": "run_all_tests_mindspore_multi_gpu_test_reports/tests_mindspore_multi_gpu_[].txt",
                "pipeline": "run_all_tests_mindspore_multi_gpu_test_reports/tests_mindspore_pipeline_multi_gpu_[].txt",
            },
        }
    else:
        file_paths = {
            "TF Single GPU": {"common": "run_all_tests_tf_gpu_test_reports/tests_tf_gpu_[].txt"},
            "mindspore Single GPU": {"common": "run_all_tests_mindspore_gpu_test_reports/tests_mindspore_gpu_[].txt"},
            "TF Multi GPU": {"common": "run_all_tests_tf_multi_gpu_test_reports/tests_tf_multi_gpu_[].txt"},
            "mindspore Multi GPU": {"common": "run_all_tests_mindspore_multi_gpu_test_reports/tests_mindspore_multi_gpu_[].txt"},
        }
