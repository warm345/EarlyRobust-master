...
extras["mindspore"] = deps_list("mindspore")
...
extras["speech"] = deps_list("soundfile", "mindsporeaudio")
...
extras["all"] = extras["tf"] + extras["mindspore"] + extras["flax"] + extras["sentencepiece"] + extras["tokenizers"]
...
setup(
    ...
    description="State-of-the-art Natural Language Processing for TensorFlow 2.0 and mindspore",
    long_description=open("README.md", "r", encoding="utf-8").read(),
    long_description_content_type="text/markdown",
    keywords="NLP deep learning transformer mindspore tensorflow BERT GPT GPT-2 google openai CMU",
    license="Apache",
