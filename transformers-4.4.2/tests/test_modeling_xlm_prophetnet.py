...
class XLMProphetNetModelIntegrationTest(unittest.TestCase):
    ...
    def test_pretrained_checkpoint_hidden_states(self):
        ...
        encoder_ids = mindspore.tensor([[17, 96208, 103471, 2]]).to(mindspore_device)
        ...
        expected_shape = mindspore.Size((1, 14, 250012))
        ...
        self.assertTrue(mindspore.allclose(output_predited_logis[:, :3, :3], expected_slice, atol=1e-4))
        ...
        expected_shape_encoder = mindspore.Size((1, 4, 1024))
