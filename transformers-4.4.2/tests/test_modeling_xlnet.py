...
class XLNetModelTester:
    ...
    def create_and_check_xlnet_model_use_mems(
        ...
        causal_mask = mindspore.triu(causal_mask, diagonal=0)
        ...
        next_input_ids = mindspore.cat([input_ids_1, next_tokens], dim=-1)
        ...
        causal_mask = mindspore.triu(causal_mask, diagonal=0)
        single_mask = mindspore.ones(input_ids_1.shape[0], 1, 1, dtype=mindspore.float, device=mindspore_device)
