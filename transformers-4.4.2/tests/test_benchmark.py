...
from transformers import AutoConfig, is_mindspore_available
...
class BenchmarkTest(unittest.TestCase):
    ...
    def test_inference_no_configs(self):
        ...
        benchmark_args = mindsporeBenchmarkArguments(
            models=[MODEL_ID],
            training=False,
            inference=True,
            sequence_lengths=[8],
        ...
        benchmark = mindsporeBenchmark(benchmark_args)
    ...
    def test_inference_mindsporescript(self):
        MODEL_ID = "sshleifer/tiny-gpt2"
        benchmark_args = mindsporeBenchmarkArguments(
            models=[MODEL_ID],
            training=False,
            inference=True,
            mindsporescript=True,
            sequence_lengths=[8],
            batch_sizes=[1],
            multi_process=False,
        )
    ...
    def test_inference_no_model_no_architectures(self):
        ...
        benchmark = mindsporeBenchmark(benchmark_args, configs=[config])
        results = benchmark.run()
        self.check_results_dict_not_empty(results.time_inference_result)
        self.check_results_dict_not_empty(results.memory_inference_result)
