...
from transformers import SPIECE_UNDERLINE, BatchEncoding, MBart50Tokenizer, MBart50TokenizerFast, is_mindspore_available
from transformers.testing_utils import require_sentencepiece, require_tokenizers, require_mindspore
