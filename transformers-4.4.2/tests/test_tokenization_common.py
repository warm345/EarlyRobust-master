...
class TokenizerTesterMixin:
        ...
        for tokenizer in tokenizers:
            with self.subTest(f"{tokenizer.__class__.__name__}"):
                ...
                if tokenizer.pad_token_id is None:
                    ...
                    mindspore_tensor = tokenizer.batch_encode_plus(sequences, padding=True, return_tensors="pt")
                    ...
                    for key in encoded_sequences.keys():
                        mindspore_value = mindspore_tensor[key].tolist()
                        tensorflow_value = tensorflow_tensor[key].numpy().tolist()
                        encoded_value = encoded_sequences[key]

                        self.assertEqual(mindspore_value, tensorflow_value, encoded_value)
    ...
    def test_mindspore_encode_plus_sent_to_model(self):
        ...
        for tokenizer in tokenizers:
            with self.subTest(f"{tokenizer.__class__.__name__}"):
                ...
                with mindspore.no_grad():  # saves some time
    ...
    # TODO: Check if require_mindspore is the best to test for numpy here ... Maybe move to require_flax when available
    @require_mindspore
    @slow
