...
from transformers import is_tf_available, is_mindspore_available, pipeline
from transformers.file_utils import to_py_obj
from transformers.pipelines import Pipeline
from transformers.testing_utils import _run_slow_tests, is_pipeline_test, require_tf, require_mindspore, slow
...
class CustomInputPipelineCommonMixin:
    ...
    @require_mindspore
    def test_compare_slow_fast_mindspore(self):
        for model_name in self.small_models:
            nlp_slow = pipeline(
                task=self.pipeline_task,
                model=model_name,
