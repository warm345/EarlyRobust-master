...
""" Testing suite for the mindspore Speech2Text model. """
...
class Speech2TextModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        attention_mask = mindspore.ones([self.batch_size, self.seq_length], dtype=mindspore.long, device=mindspore_device)
    ...
    def create_and_check_decoder_model_past_large_inputs(self, config, inputs_dict):
        model = Speech2TextModel(config=config).get_decoder().to(mindspore_device).eval()
    ...
    def check_encoder_decoder_model_standalone(self, config, inputs_dict):
        model = Speech2TextModel(config=config).to(mindspore_device).eval()
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            encoder = Speech2TextEncoder.from_pretrained(tmpdirname).to(mindspore_device)
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            decoder = Speech2TextDecoder.from_pretrained(tmpdirname).to(mindspore_device)
...
class Speech2TextModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def test_generate_fp16(self):
        ...
        model = Speech2TextForConditionalGeneration(config).eval().to(mindspore_device)
    ...
    def _get_encoder_outputs(
        ...
        input_ids = mindspore.zeros_like(input_ids[:, :1], dtype=mindspore.long) + model._get_decoder_start_token_id()
        attention_mask = None
...
class Speech2TextModelIntegrationTests(unittest.TestCase):
    ...
    def test_generation_librispeech(self):
        ...
        input_features = processor(input_speech, return_tensors="pt").input_features.to(mindspore_device)
    ...
    def test_generation_librispeech_batched(self):
        ...
        input_features = inputs.input_features.to(mindspore_device)
