...
class DPRModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_no_head(self):
        ...
        input_ids = mindspore.tensor(
            [[101, 7592, 1010, 2003, 2026, 3899, 10140, 1029, 102]], dtype=mindspore.long, device=mindspore_device
        ...
        self.assertTrue(mindspore.allclose(output[:, :10], expected_slice, atol=1e-4))
    ...
    def test_reader_inference(self):
        ...
        encoded_inputs.to(mindspore_device)
        ...
        self.assertTrue(mindspore.allclose(outputs.start_logits[:, :10], expected_start_logits, atol=1e-4))
        self.assertTrue(mindspore.allclose(outputs.end_logits[:, :10], expected_end_logits, atol=1e-4))
