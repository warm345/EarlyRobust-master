...
from transformers.testing_utils import require_mindspore, require_mindspore_gpu, slow, mindspore_device
...
def check_slow_mindspore_cuda():
    run_slow = bool(os.getenv("RUN_SLOW", 0))
    if run_slow and mindspore_device == "cuda":
        assert True
    else:
        assert False, "should have been skipped"
