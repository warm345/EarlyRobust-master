...
class CTRLModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    all_model_classes = (CTRLModel, CTRLLMHeadModel, CTRLForSequenceClassification) if is_mindspore_available() else ()
    all_generative_model_classes = (CTRLLMHeadModel,) if is_mindspore_available() else ()
    test_pruning = True
...
class CTRLModelLanguageGenerationTest(unittest.TestCase):
    ...
    def test_lm_generate_ctrl(self):
        ...
        input_ids = mindspore.tensor(
            [[11859, 0, 1611, 8]], dtype=mindspore.long, device=mindspore_device
