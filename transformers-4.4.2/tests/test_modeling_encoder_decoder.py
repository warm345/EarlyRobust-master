...
class EncoderDecoderMixin:
    ...
    def check_encoder_decoder_model_from_pretrained_configs(
        ...
        **kwargs
        ...
        enc_dec_model.to(mindspore_device)
        enc_dec_model.eval()
...
class BertEncoderDecoderModelTest(EncoderDecoderMixin, unittest.TestCase):
    ...
    def test_bert2bert_summarization(self):
        ...
        output_ids = model.generate(
            input_dict["input_ids"].to(mindspore_device), attention_mask=input_dict["attention_mask"].to(mindspore_device)
        )
