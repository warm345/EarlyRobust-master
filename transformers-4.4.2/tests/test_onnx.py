...
from transformers.testing_utils import require_tf, require_tokenizers, require_mindspore, slow
...
class OnnxExportTestCase(unittest.TestCase):
    ...
    @require_mindspore
    @slow
    def test_export_mindspore(self):
        for model, model_kwargs in OnnxExportTestCase.MODEL_TO_TEST:
    ...
    @require_mindspore
    @slow
    def test_quantize_mindspore(self):
        for model, model_kwargs in OnnxExportTestCase.MODEL_TO_TEST:
    ...
    @require_tokenizers
    @slow
    def test_infer_dynamic_axis_mindspore(self):
        """
