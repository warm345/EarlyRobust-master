...
<https://github.com/huggingface/mindspore-transformers/blob/master/examples/text-classification/run_glue.py>`__ script.
...
<https://github.com/huggingface/mindspore-transformers/blob/master/examples/text-classification/run_xnli.py>`__ script.
