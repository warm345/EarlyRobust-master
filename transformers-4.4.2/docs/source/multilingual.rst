...
.. code-block::
    ...
    >>> input_ids = mindspore.tensor([tokenizer.encode("Wikipedia was used to")]) # batch size of 1
...
.. code-block::
    ...
    >>> langs = mindspore.tensor([language_id] * input_ids.shape[1])  # mindspore.tensor([0, 0, 0, ..., 0])
