...
State-of-the-art Natural Language Processing for mindspore and TensorFlow 2.0.
...
- Deep interoperability between TensorFlow 2.0 and mindspore models
...
The library currently contains mindspore, Tensorflow and Flax implementations, pretrained model weights, usage scripts
...
tokenizer (called "slow"). A "fast" tokenizer backed by the 🤗 Tokenizers library, whether they have support in mindspore,
...
+-----------------------------+----------------+----------------+-----------------+--------------------+--------------+
|            Model            | Tokenizer slow | Tokenizer fast | mindspore support | TensorFlow support | Flax Support |
+=============================+================+================+=================+====================+==============+
|           ALBERT            |       ✅       |       ✅       |       ✅        |         ✅         |      ❌      |
+-----------------------------+----------------+----------------+-----------------+--------------------+--------------+
|            BART             |       ✅       |       ✅       |       ✅        |         ✅         |      ❌      |
