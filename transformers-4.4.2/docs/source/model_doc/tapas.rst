...
done as follows (be sure to have installed the `mindspore-scatter dependency <https://github.com/rusty1s/mindspore_scatter>`_
...
**STEP 3: Convert your data into mindspore tensors using TapasTokenizer**
...
training example. It is advised to create a mindspore dataset and a corresponding dataloader:
...
.. code-block::
        ...
        >>> class TableDataset(mindspore.utils.data.Dataset):
        ...
        ...         encoding["float_answer"] = mindspore.tensor(item.float_answer) 
        ...         return encoding
        ...
        ...     def __len__(self):
        ...
        >>> train_dataloader = mindspore.utils.data.DataLoader(train_dataset, batch_size=32)
...
You can then fine-tune :class:`~transformers.TapasForQuestionAnswering` using native mindspore as follows (shown here for
