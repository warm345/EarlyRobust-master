...
export PAIR=ru-en
PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/wmt19.$PAIR.ensemble/model4.pt --mindspore_dump_folder_path data/wmt19-$PAIR

export PAIR=en-ru
PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/wmt19.$PAIR.ensemble/model4.pt --mindspore_dump_folder_path data/wmt19-$PAIR

export PAIR=de-en
PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/wmt19.$PAIR.joined-dict.ensemble/model4.pt --mindspore_dump_folder_path data/wmt19-$PAIR
