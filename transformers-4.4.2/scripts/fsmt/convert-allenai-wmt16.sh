...
PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/trans_ende-dist_12-1_0.2/checkpoint_top5_average.pt --mindspore_dump_folder_path data/wmt16-en-de-dist-12-1

PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/trans_ende-dist_6-1_0.2/checkpoint_top5_average.pt --mindspore_dump_folder_path data/wmt16-en-de-dist-6-1

PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/trans_ende_12-1_0.2/checkpoint_top5_average.pt --mindspore_dump_folder_path data/wmt16-en-de-12-1
