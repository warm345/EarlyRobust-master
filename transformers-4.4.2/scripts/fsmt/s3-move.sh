...
transformers-cli s3 rm wmt16-en-de-12-1/mindspore_model.bin
...
transformers-cli s3 rm wmt16-en-de-dist-12-1/mindspore_model.bin
...
transformers-cli s3 rm wmt16-en-de-dist-6-1/mindspore_model.bin
...
transformers-cli s3 rm wmt19-de-en-6-6-base/mindspore_model.bin
...
transformers-cli s3 rm wmt19-de-en-6-6-big/mindspore_model.bin
...
transformers-cli s3 rm wmt19-de-en/mindspore_model.bin
...
transformers-cli s3 rm wmt19-en-de/mindspore_model.bin
...
transformers-cli s3 rm wmt19-en-ru/mindspore_model.bin
...
transformers-cli s3 rm wmt19-ru-en/mindspore_model.bin
