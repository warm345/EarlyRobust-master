...
PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/wmt19_deen_base_dr0.1_1/checkpoint_last3_avg.pt --mindspore_dump_folder_path data/wmt19-de-en-6-6-base

PYTHONPATH="src" python src/transformers/convert_fsmt_original_mindspore_checkpoint_to_mindspore.py --fsmt_checkpoint_path data/wmt19_deen_big_dr0.1_2/checkpoint_last3_avg.pt --mindspore_dump_folder_path data/wmt19-de-en-6-6-big
