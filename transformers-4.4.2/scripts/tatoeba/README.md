...
```bash
python src/transformers/models/marian/convert_marian_tatoeba_to_mindspore.py --models heb-eng eng-heb --save_dir converted
```
...
```python
from transformers.convert_marian_tatoeba_to_mindspore import TatoebaConverter
