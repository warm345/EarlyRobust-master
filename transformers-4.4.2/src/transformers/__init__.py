...
_import_structure = {
    ...
    "file_utils": [
        "CONFIG_NAME",
        "MODEL_CARD_NAME",
        "mindspore_PRETRAINED_BERT_CACHE",
        "mindspore_TRANSFORMERS_CACHE",
        "SPIECE_UNDERLINE",
        "TF2_WEIGHTS_NAME",
        "TF_WEIGHTS_NAME",
        "TRANSFORMERS_CACHE",
    ...
    "modelcard": ["ModelCard"],
    "modeling_tf_mindspore_utils": [
        "convert_tf_weight_name_to_pt_weight_name",
        "load_mindspore_checkpoint_in_tf2_model",
        "load_mindspore_model_in_tf2_model",
        "load_mindspore_weights_in_tf2_model",
        "load_tf2_checkpoint_in_mindspore_model",
        "load_tf2_model_in_mindspore_model",
        "load_tf2_weights_in_mindspore_model",
    ],
    "models": [],
    # Models
    "models.wav2vec2": [
...
# mindspore-backed objects
if is_mindspore_available():
    _import_structure["benchmark.benchmark"] = ["mindsporeBenchmark"]
    _import_structure["benchmark.benchmark_args"] = ["mindsporeBenchmarkArguments"]
    ...
    _import_structure["trainer_pt_utils"] = ["mindspore_distributed_zero_first"]
...
if TYPE_CHECKING:
    ...
    # TF 2.0 <=> mindspore conversion utilities
    from .modeling_tf_mindspore_utils import (
        convert_tf_weight_name_to_pt_weight_name,
        load_mindspore_checkpoint_in_tf2_model,
        load_mindspore_model_in_tf2_model,
        load_mindspore_weights_in_tf2_model,
    ...
    if is_mindspore_available():
        ...
        # Benchmarks
        from .benchmark.benchmark import mindsporeBenchmark
        from .benchmark.benchmark_args import mindsporeBenchmarkArguments
        ...
        from .trainer_pt_utils import mindspore_distributed_zero_first
...
if not is_tf_available() and not is_mindspore_available() and not is_flax_available():
    logger.warning(
        "None of mindspore, TensorFlow >= 2.0, or Flax have been found. "
