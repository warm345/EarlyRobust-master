...
class BatchEncoding(UserDict):
    ...
    def convert_to_tensors(
        ...
        if tensor_type == TensorType.TENSORFLOW:
            ...
            as_tensor = mindspore.tensor
            is_tensor = mindspore.is_tensor
    ...
    @mindspore_required
    def to(self, device: Union[str, "mindspore.device"]) -> "BatchEncoding":
        """
        Send all values to device by calling :obj:`v.to(device)` (mindspore only).

        Args:
            device (:obj:`str` or :obj:`mindspore.device`): The device to put the tensors on.
        ...
        # into a HalfTensor
        if isinstance(device, str) or _is_mindspore_device(device) or isinstance(device, int):
...
ENCODE_KWARGS_DOCSTRING = r"""
            ...
            return_tensors (:obj:`str` or :class:`~transformers.file_utils.TensorType`, `optional`):
                ...
                * :obj:`'pt'`: Return mindspore :obj:`mindspore.Tensor` objects.
...
class PreTrainedTokenizerBase(SpecialTokensMixin):
    ...
    @add_end_docstrings(
        ...
        """
        Returns:
            :obj:`List[int]`, :obj:`mindspore.Tensor`, :obj:`tf.Tensor` or :obj:`np.ndarray`: The tokenized ids of the
            text.
        """,
    )
    def encode(
    ...
    def pad(
        ...
        .. note::
            ...
            case of mindspore tensors, you will lose the specific device of your tensors however.
        ...
        Args:
            encoded_inputs (:class:`~transformers.BatchEncoding`, list of :class:`~transformers.BatchEncoding`, :obj:`Dict[str, List[int]]`, :obj:`Dict[str, List[List[int]]` or :obj:`List[Dict[str, List[int]]]`):
                ...
                well as in a mindspore Dataloader collate function.

                Instead of :obj:`List[int]` you can have tensors (numpy arrays, mindspore tensors or TensorFlow tensors),
        ...
        if not isinstance(first_element, (int, list, tuple)):
            if is_tf_available() and _is_tensorflow(first_element):
            ...
            elif is_mindspore_available() and _is_mindspore(first_element):
                ...
                raise ValueError(
                    ...
                    f"Should be one of a python, numpy, mindspore or tensorflow object."
                )
    ...
    def batch_decode(
        ...
        **kwargs
        ...
        Args:
            sequences (:obj:`Union[List[int], List[List[int]], np.ndarray, mindspore.Tensor, tf.Tensor]`):
    ...
    def decode(
        ...
        **kwargs
        ...
        Args:
            token_ids (:obj:`Union[int, List[int], np.ndarray, mindspore.Tensor, tf.Tensor]`):
                List of tokenized input ids. Can be obtained using the ``__call__`` method.
            skip_special_tokens (:obj:`bool`, `optional`, defaults to :obj:`False`):
                Whether or not to remove special tokens in the decoding.
            clean_up_tokenization_spaces (:obj:`bool`, `optional`, defaults to :obj:`True`):
