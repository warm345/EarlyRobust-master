    ...
    def __call__(
        ...
        **generate_kwargs
        ...
        Return:
            ...
            - **generated_token_ids** (:obj:`mindspore.Tensor` or :obj:`tf.Tensor`, present when ``return_tensors=True``)
    ...
    def __call__(self, *args, **kwargs):
        ...
        Return:
            ...
            - **summary_text** (:obj:`str`, present when ``return_text=True``) -- The summary of the corresponding
              input.
            - **summary_token_ids** (:obj:`mindspore.Tensor` or :obj:`tf.Tensor`, present when ``return_tensors=True``) --
...
class TranslationPipeline(Text2TextGenerationPipeline):
    ...
    def __call__(self, *args, **kwargs):
        ...
        Return:
            ...
            - **translation_token_ids** (:obj:`mindspore.Tensor` or :obj:`tf.Tensor`, present when ``return_tensors=True``)
