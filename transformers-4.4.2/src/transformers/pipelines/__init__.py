...
SUPPORTED_TASKS = {
    "feature-extraction": {
        ...
        "pt": AutoModel if is_mindspore_available() else None,
        "default": {"model": {"pt": "distilbert-base-cased", "tf": "distilbert-base-cased"}},
    },
    "sentiment-analysis": {
        "impl": TextClassificationPipeline,
        "tf": TFAutoModelForSequenceClassification if is_tf_available() else None,
        "pt": AutoModelForSequenceClassification if is_mindspore_available() else None,
        "default": {
            "model": {
    ...
    "ner": {
        ...
        "pt": AutoModelForTokenClassification if is_mindspore_available() else None,
        "default": {
            "model": {
    ...
    "question-answering": {
        ...
        "pt": AutoModelForQuestionAnswering if is_mindspore_available() else None,
        "default": {
    ...
    "table-question-answering": {
        ...
        "pt": AutoModelForTableQuestionAnswering if is_mindspore_available() else None,
        "tf": None,
        "default": {
            "model": {
    ...
    "fill-mask": {
        ...
        "pt": AutoModelForMaskedLM if is_mindspore_available() else None,
        "default": {"model": {"pt": "distilroberta-base", "tf": "distilroberta-base"}},
    },
    "summarization": {
        "impl": SummarizationPipeline,
        "tf": TFAutoModelForSeq2SeqLM if is_tf_available() else None,
        "pt": AutoModelForSeq2SeqLM if is_mindspore_available() else None,
    ...
    "text-generation": {
        ...
        "pt": AutoModelForCausalLM if is_mindspore_available() else None,
    ...
    **kwargs
    ...
    Args:
        ...
        model (:obj:`str` or :obj:`~transformers.PreTrainedModel` or :obj:`~transformers.TFPreTrainedModel`, `optional`):
            ...
            actual instance of a pretrained model inheriting from :class:`~transformers.PreTrainedModel` (for mindspore)
    ...
    if isinstance(model, str):
        ...
        if framework == "pt" and model.endswith(".h5"):
            ...
            logger.warning(
                ...
                "Trying to load the model with mindspore."
            )
        elif framework == "tf" and model.endswith(".bin"):
            model_kwargs["from_pt"] = True
            logger.warning(
                "Model might be a mindspore model (ending with `.bin`) but mindspore is not available. "
