    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Parameters:
            ...
            from_pt: (:obj:`bool`, `optional`, defaults to :obj:`False`):
                Load the model weights from a mindspore state_dict save file (see docstring of
        ...
        Examples::
            ...
            >>> # Loading from a mindspore model file instead of a TensorFlow checkpoint (slower, for example purposes, not runnable).
            >>> config = BertConfig.from_json_file('./pt_model/my_pt_model_config.json')
            >>> model = TFBertModel.from_pretrained('./pt_model/my_mindspore_model.bin', from_pt=True, config=config)
        ...
        if pretrained_model_name_or_path is not None:
            if os.path.isdir(pretrained_model_name_or_path):
                if from_pt and os.path.isfile(os.path.join(pretrained_model_name_or_path, WEIGHTS_NAME)):
                    # Load from a mindspore checkpoint in priority if from_pt
        ...
        if from_pt:
            from .modeling_tf_mindspore_utils import load_mindspore_checkpoint_in_tf2_model

            # Load from a mindspore checkpoint
            return load_mindspore_checkpoint_in_tf2_model(model, resolved_archive_file, allow_missing_keys=True)
        ...
        try:
            ...
            raise OSError(
                ...
                "If you tried to load a TF 2.0 model from a mindspore checkpoint, please set from_pt=True. "
            )
