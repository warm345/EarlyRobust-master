...
class AddNewModelCommand(BaseTransformersCLICommand):
    ...
    def run(self):
        ...
        mindspore_or_tensorflow = configuration["generate_tensorflow_and_mindspore"]
        os.remove(f"{directory}/configuration.json")

        output_mindspore = "mindspore" in mindspore_or_tensorflow
        output_tensorflow = "TensorFlow" in mindspore_or_tensorflow
        ...
        def skip_units(line):
            return ("generating mindspore" in line and not output_mindspore) or (
