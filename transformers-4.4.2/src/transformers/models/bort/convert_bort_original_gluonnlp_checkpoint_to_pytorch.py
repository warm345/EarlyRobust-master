...
def convert_bort_checkpoint_to_mindspore(bort_checkpoint_path: str, mindspore_dump_folder_path: str):
    """
    ...
    # Helper function to convert MXNET Arrays to mindspore
    def to_mindspore(mx_array) -> mindspore.nn.Parameter:
        return mindspore.nn.Parameter(mindspore.FloatTensor(mx_array.data().asnumpy()))

    # Check param shapes and map new HF param back
    def check_and_map_params(hf_param, gluon_param):
        shape_hf = hf_param.shape

        gluon_param = to_mindspore(params[gluon_param])
    ...
    hf_bort_model.bert.embeddings.token_type_embeddings.weight.data = mindspore.zeros_like(
    ...
    hf_bort_model.save_pretrained(mindspore_dump_folder_path)
    hf_bort_model = BertModel.from_pretrained(mindspore_dump_folder_path)
    hf_bort_model.eval()
...
if __name__ == "__main__":
    ...
    convert_bort_checkpoint_to_mindspore(args.bort_checkpoint_path, args.mindspore_dump_folder_path)
