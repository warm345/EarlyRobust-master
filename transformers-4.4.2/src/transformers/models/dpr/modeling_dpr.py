...
class DPRContextEncoderOutput(ModelOutput):
    ...
    Args:
        pooler_output: (:obj:``mindspore.FloatTensor`` of shape ``(batch_size, embeddings_size)``):
    ...
    pooler_output: mindspore.FloatTensor
...
class DPRReaderOutput(ModelOutput):
    ...
    Args:
        start_logits: (:obj:``mindspore.FloatTensor`` of shape ``(n_passages, sequence_length)``):
            Logits of the start index of the span for each passage.
        end_logits: (:obj:``mindspore.FloatTensor`` of shape ``(n_passages, sequence_length)``):
            Logits of the end index of the span for each passage.
        relevance_logits: (:obj:`mindspore.FloatTensor`` of shape ``(n_passages, )``):
    ...
    start_logits: mindspore.FloatTensor
    end_logits: mindspore.FloatTensor = None
    relevance_logits: mindspore.FloatTensor = None
    hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    attentions: Optional[Tuple[mindspore.FloatTensor]] = None
...
DPR_READER_INPUTS_DOCSTRING = r"""
    Args:
        input_ids: (:obj:`Tuple[mindspore.LongTensor]` of shapes :obj:`(n_passages, sequence_length)`):
            ...
            `What are input IDs? <../glossary.html#input-ids>`__
        attention_mask (:obj:`mindspore.FloatTensor` of shape :obj:`(n_passages, sequence_length)`, `optional`):
            Mask to avoid performing attention on padding token indices. Mask values selected in ``[0, 1]``:
            ...
            `What are attention masks? <../glossary.html#attention-mask>`__
        inputs_embeds (:obj:`mindspore.FloatTensor` of shape :obj:`(n_passages, sequence_length, hidden_size)`, `optional`):
            Optionally, instead of passing :obj:`input_ids` you can choose to directly pass an embedded representation.
            This is useful if you want more control over how to convert :obj:`input_ids` indices into associated
            vectors than the model's internal embedding lookup matrix.
        output_attentions (:obj:`bool`, `optional`):
...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        if attention_mask is None:
            attention_mask = (
                mindspore.ones(input_shape, device=device)
