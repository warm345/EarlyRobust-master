...
import mindspore
from mindspore.serialization import default_restore_location
...
def load_states_from_checkpoint(model_file: str) -> CheckpointState:
    ...
    state_dict = mindspore.load(model_file, map_location=lambda s, l: default_restore_location(s, "cpu"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dest", type=str, default=None, help="Path to the output mindspore model directory.")
