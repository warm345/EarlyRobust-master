...
class TFTransfoXLMainLayer(tf.keras.layers.Layer):
    ...
    def call(
        ...
        **kwargs,
        ...
        # ::: mindspore masking code for reference :::
        # if self.same_length:
        ...
        #     else:
        #         mask_shift_len = qlen
        #     dec_attn_mask = (mindspore.triu(all_ones, 1+mlen)
        #             + mindspore.tril(all_ones, -mask_shift_len))[:, :, None] # -1
        # else:
        #     dec_attn_mask = mindspore.triu(
        #         word_emb.new_ones((qlen, klen), dtype=mindspore.uint8), diagonal=1+mlen)[:,:,None]
...
TRANSFO_XL_START_DOCSTRING = r"""
    ...
    .. note::
        ...
        - having all inputs as keyword arguments (like mindspore models), or
