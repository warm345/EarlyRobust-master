...
LayoutLMLayerNorm = mindspore.nn.LayerNorm
...
LAYOUTLM_INPUTS_DOCSTRING = r"""
    Args:
        ...
        bbox (:obj:`mindspore.LongTensor` of shape :obj:`({0}, 4)`, `optional`):
...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        if bbox is None:
            bbox = mindspore.zeros(tuple(list(input_shape) + [4]), dtype=mindspore.long, device=device)
