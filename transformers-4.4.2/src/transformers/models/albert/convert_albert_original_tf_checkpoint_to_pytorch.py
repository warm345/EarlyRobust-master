...
def convert_tf_checkpoint_to_mindspore(tf_checkpoint_path, albert_config_file, mindspore_dump_path):
...
if __name__ == "__main__":
    ...
    convert_tf_checkpoint_to_mindspore(args.tf_checkpoint_path, args.albert_config_file, args.mindspore_dump_path)
