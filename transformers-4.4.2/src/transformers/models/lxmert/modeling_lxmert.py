...
class LxmertModelOutput(ModelOutput):
    ...
    Args:
        language_output (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length, hidden_size)`):
            Sequence of hidden-states at the output of the last layer of the language encoder.
        vision_output (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length, hidden_size)`):
        ...
        language_hidden_states (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_hidden_states=True`` is passed or when ``config.output_hidden_states=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for input features + one for the output of each cross-modality
            layer) of shape :obj:`(batch_size, sequence_length, hidden_size)`.
        vision_hidden_states (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_hidden_states=True`` is passed or when ``config.output_hidden_states=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for input features + one for the output of each cross-modality
            layer) of shape :obj:`(batch_size, sequence_length, hidden_size)`.
        language_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`. Attentions weights after the attention softmax, used to compute the
            weighted average in the self-attention heads.
        vision_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`. Attentions weights after the attention softmax, used to compute the
            weighted average in the self-attention heads.
        cross_encoder_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`. Attentions weights after the attention softmax, used to compute the
            weighted average in the self-attention heads.
    """

    language_output: Optional[mindspore.FloatTensor] = None
    vision_output: Optional[mindspore.FloatTensor] = None
    pooled_output: Optional[mindspore.FloatTensor] = None
    language_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    vision_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    language_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    vision_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    cross_encoder_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
...
class LxmertForQuestionAnsweringOutput(ModelOutput):
    ...
    Args:
        loss (`optional`, returned when ``labels`` is provided, ``mindspore.FloatTensor`` of shape :obj:`(1,)`):
            Total loss as the sum of the masked language modeling loss and the next sequence prediction
            (classification) loss.k.
        question_answering_score: (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, n_qa_answers)`, `optional`):
    ...
    question_answering_score: Optional[mindspore.FloatTensor] = None
    language_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    vision_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    language_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    vision_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
...
class LxmertForPreTrainingOutput(ModelOutput):
    ...
    Args:
        loss (`optional`, returned when ``labels`` is provided, ``mindspore.FloatTensor`` of shape :obj:`(1,)`):
            Total loss as the sum of the masked language modeling loss and the next sequence prediction
            (classification) loss.
        prediction_logits (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length, config.vocab_size)`):
            Prediction scores of the language modeling head (scores for each vocabulary token before SoftMax).
        cross_relationship_score: (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, 2)`):
            Prediction scores of the textual matching objective (classification) head (scores of True/False
            continuation before SoftMax).
        question_answering_score: (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, n_qa_answers)`):
            Prediction scores of question answering objective (classification).
        language_hidden_states (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_hidden_states=True`` is passed or when ``config.output_hidden_states=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for input features + one for the output of each cross-modality
            layer) of shape :obj:`(batch_size, sequence_length, hidden_size)`.
    ...
    loss: [mindspore.FloatTensor] = None
    prediction_logits: Optional[mindspore.FloatTensor] = None
    cross_relationship_score: Optional[mindspore.FloatTensor] = None
    question_answering_score: Optional[mindspore.FloatTensor] = None
    language_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    vision_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    language_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
...
class LxmertLMPredictionHead(nn.Module):
    def __init__(self, config, lxmert_model_embedding_weights):
        ...
        self.bias = nn.Parameter(mindspore.zeros(lxmert_model_embedding_weights.size(0)))
...
LXMERT_INPUTS_DOCSTRING = r"""
    ...
    Args:
        ...
        visual_feats: (:obj:`mindspore.FloatTensor` of shape :obj:՝(batch_size, num_visual_features, visual_feat_dim)՝):
            This input represents visual features. They ROI pooled object features from bounding boxes using a
            faster-RCNN model)

            These are currently not provided by the transformers library.
        visual_pos: (:obj:`mindspore.FloatTensor` of shape :obj:՝(batch_size, num_visual_features, visual_pos_dim)՝):
        ...
        visual_attention_mask (:obj:`mindspore.FloatTensor` of shape :obj:`({0})`, `optional`):
            Mask to avoid performing attention on padding token indices. Mask values selected in ``[0, 1]``:
...
class LxmertForPreTraining(LxmertPreTrainedModel):
    ...
    def resize_num_qa_labels(self, num_labels):
        ...
        Args:
            num_labels (:obj:`int`, `optional`):
                ...
                just returns a pointer to the qa labels :obj:`mindspore.nn.Linear`` module of the model without doing
                anything.

        Return:
            :obj:`mindspore.nn.Linear`: Pointer to the resized Linear layer or the old Linear layer
        """
    ...
    def get_qa_logit_layer(self) -> nn.Module:
        ...
        Returns:
            :obj:`nn.Module`: A mindspore module mapping the question answering prediction hidden states or :obj:`None` if
    ...
    def forward(
        ...
        **kwargs,
        ...
        obj_labels: (``Dict[Str: Tuple[mindspore.FloatTensor, mindspore.FloatTensor]]``, `optional`):
        ...
        total_loss = (
            ...
            else mindspore.tensor(0.0, device=device)
        )
        ...
        if obj_labels is not None and self.task_obj_predict:
            total_visual_loss = mindspore.tensor(0.0, device=input_ids.device)
...
class LxmertForQuestionAnswering(LxmertPreTrainedModel):
    ...
    def get_qa_logit_layer(self) -> nn.Module:
        ...
        Returns:
            :obj:`nn.Module`: A mindspore module mapping the question answering prediction hidden states. :obj:`None`: A
