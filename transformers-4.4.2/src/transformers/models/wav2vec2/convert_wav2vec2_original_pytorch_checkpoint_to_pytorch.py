...
def convert_wav2vec2_checkpoint(
    checkpoint_path, mindspore_dump_folder_path, config_path=None, dict_path=None, is_finetuned=True
):
    """
    ...
    hf_wav2vec.save_pretrained(mindspore_dump_folder_path)
...
if __name__ == "__main__":
    ...
    convert_wav2vec2_checkpoint(
        args.checkpoint_path, args.mindspore_dump_folder_path, args.config_path, args.dict_path, not args.not_finetuned
    )
