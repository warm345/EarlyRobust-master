...
class LongformerBaseModelOutputWithPooling(ModelOutput):
    ...
    last_hidden_state: mindspore.FloatTensor
    pooler_output: mindspore.FloatTensor = None
    hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    global_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
...
def _compute_global_attention_mask(input_ids, sep_token_id, before_sep_token=True):
    ...
    attention_mask = mindspore.arange(input_ids.shape[1], device=input_ids.device)
...
class LongformerEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.register_buffer("position_ids", mindspore.arange(config.max_position_embeddings).expand((1, -1)))
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        if token_type_ids is None:
            token_type_ids = mindspore.zeros(input_shape, dtype=mindspore.long, device=self.position_ids.device)
    ...
    def create_position_ids_from_inputs_embeds(self, inputs_embeds):
        ...
        position_ids = mindspore.arange(
            self.padding_idx + 1, sequence_length + self.padding_idx + 1, dtype=mindspore.long, device=inputs_embeds.device
        )
...
LONGFORMER_INPUTS_DOCSTRING = r"""
    Args:
        ...
        global_attention_mask (:obj:`mindspore.FloatTensor` of shape :obj:`({0})`, `optional`):
...
class LongformerModel(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> attention_mask = mindspore.ones(input_ids.shape, dtype=mindspore.long, device=input_ids.device) # initialize to local attention
            >>> global_attention_mask = mindspore.zeros(input_ids.shape, dtype=mindspore.long, device=input_ids.device) # initialize to global attention to be deactivated for all tokens
...
class LongformerForSequenceClassification(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        if global_attention_mask is None:
            ...
            global_attention_mask = mindspore.zeros_like(input_ids)
...
class LongformerForQuestionAnswering(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> answer_tokens = all_tokens[mindspore.argmax(start_logits) :mindspore.argmax(end_logits)+1]
...
class LongformerForMultipleChoice(LongformerPreTrainedModel):
    ...
    def forward(
        ...
        if global_attention_mask is None and input_ids is not None:
            ...
            global_attention_mask = mindspore.stack(
                [
