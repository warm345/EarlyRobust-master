...
def convert_openai_checkpoint_to_mindspore(openai_checkpoint_folder_path, openai_config_file, mindspore_dump_folder_path):
    # Construct model
...
if __name__ == "__main__":
    ...
    convert_openai_checkpoint_to_mindspore(
        args.openai_checkpoint_folder_path, args.openai_config_file, args.mindspore_dump_folder_path
    )
