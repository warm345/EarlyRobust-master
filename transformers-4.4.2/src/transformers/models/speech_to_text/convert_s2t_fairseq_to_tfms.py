...
def convert_fairseq_s2t_checkpoint_to_tfms(checkpoint_path, mindspore_dump_folder_path):
    m2m_100 = mindspore.load(checkpoint_path, map_location="cpu")
    args = m2m_100["args"]
...
if __name__ == "__main__":
    ...
    convert_fairseq_s2t_checkpoint_to_tfms(args.fairseq_path, args.mindspore_dump_folder_path)
