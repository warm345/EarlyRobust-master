...
class FlaxBertEmbedding(nn.Module):
    """
    Specify a new class for doing the embedding stuff as Flax's one use 'embedding' for the parameter name and mindspore
    use 'weight'
    """
...
class FlaxBertPreTrainedModel(FlaxPreTrainedModel):
    ...
    @staticmethod
    def convert_from_mindspore(pt_state: Dict, config: BertConfig) -> Dict:
        ...
        for key, tensor in pt_state.items():
            ...
            # There are some transposed parameters w.r.t their mindspore counterpart
            ...
            # Hack to correctly load some mindspore models
