...
"""
This script can be used to convert a head-less TF2.x Bert model to mindspore, as published on the official GitHub:
...
def load_tf2_weights_in_bert(model, tf_checkpoint_path, config):
    ...
    for full_name, array in zip(names, arrays):
        ...
        logger.info(f"Successfully set variable {full_name} to mindspore layer {trace}")
    return model


def convert_tf2_checkpoint_to_mindspore(tf_checkpoint_path, config_path, mindspore_dump_path):
    # Instantiate model
    ...
    logger.info(f"Saving mindspore model to {mindspore_dump_path}...")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the output mindspore model (must include filename).",
    )
    args = parser.parse_args()
    convert_tf2_checkpoint_to_mindspore(args.tf_checkpoint_path, args.bert_config_file, args.mindspore_dump_path)
