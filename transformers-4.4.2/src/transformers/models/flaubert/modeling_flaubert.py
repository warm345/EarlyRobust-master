...
""" mindspore Flaubert model, based on XLM. """
...
FLAUBERT_INPUTS_DOCSTRING = r"""
    Args:
        ...
        cache (:obj:`Dict[str, mindspore.FloatTensor]`, `optional`):
            Dictionary strings to ``mindspore.FloatTensor`` that contains precomputed hidden-states (key and values in the
...
class FlaubertModel(XLMModel):
    ...
    def forward(
        ...
        if position_ids is None:
            position_ids = mindspore.arange(slen, dtype=mindspore.long, device=device)
