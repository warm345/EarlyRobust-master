...
import mindspore.utils.checkpoint as checkpoint
...
class RetriBertModel(RetriBertPreTrainedModel):
    ...
    def embed_sentences_checkpointed(
        ...
        if checkpoint_batch_size < 0 or input_ids.shape[0] < checkpoint_batch_size:
            ...
            extended_attention_mask: mindspore.Tensor = sent_encoder.get_extended_attention_mask(
            ...
            return mindspore.cat(pooled_output_list, dim=0)
    ...
    def forward(
        ...
        r"""
        Args:
            input_ids_query (:obj:`mindspore.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
            ...
            attention_mask_query (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
            ...
            input_ids_doc (:obj:`mindspore.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                Indices of input sequence tokens in the vocabulary for the documents in a batch.
            attention_mask_doc (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length)`, `optional`):
        ...
        Return:
            :obj:`mindspore.FloatTensor`: The bidirectional cross-entropy loss obtained while trying to match each query to
        ...
        compare_scores = mindspore.mm(q_reps, a_reps.t())
        loss_qa = self.ce_loss(compare_scores, mindspore.arange(compare_scores.shape[1]).to(device))
        loss_aq = self.ce_loss(compare_scores.t(), mindspore.arange(compare_scores.shape[0]).to(device))
