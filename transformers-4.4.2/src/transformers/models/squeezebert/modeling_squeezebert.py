...
class MatMulWrapper(mindspore.nn.Module):
    """
    Wrapper for mindspore.matmul(). This makes flop-counting easier to implement. Note that if you directly call
    mindspore.matmul() in your code, the flop counter will typically ignore the flops of the matmul.
    """
    ...
    def forward(self, mat1, mat2):
        ...
        :param inputs: two mindspore tensors :return: matmul of these tensors
        ...
        """
        return mindspore.matmul(mat1, mat2)
