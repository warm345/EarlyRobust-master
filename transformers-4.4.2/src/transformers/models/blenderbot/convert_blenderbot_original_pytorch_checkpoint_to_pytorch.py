...
@mindspore.no_grad()
def convert_parlai_checkpoint(checkpoint_path, mindspore_dump_folder_path, config_json_path):
    """
    Copy/paste/tweak model's weights to our BERT structure.
    """
    model = mindspore.load(checkpoint_path, map_location="cpu")
    sd = model["model"]
    ...
    m.half()
    m.save_pretrained(mindspore_dump_folder_path)
