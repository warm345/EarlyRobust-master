...
class RetrievAugLMMarginOutput(ModelOutput):
    ...
    Args:
        ...
        doc_scores (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, config.n_docs)`):
        ...
        retrieved_doc_embeds (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, config.n_docs, hidden_size)`, `optional`, returned when `output_retrieved=True`):
            Embedded documents retrieved by the retriever. Is used with ``question_encoder_last_hidden_state`` to
            compute the ``doc_scores``.
        retrieved_doc_ids (:obj:`mindspore.LongTensor` of shape :obj:`(batch_size, config.n_docs)`, `optional`, returned when `output_retrieved=True`):
            The indexes of the embedded documents retrieved by the retriever.
        context_input_ids (:obj:`mindspore.LongTensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
            Input ids post-processed from the retrieved documents and the question encoder input_ids by the retriever.
        context_attention_mask (:obj:`mindspore.LongTensor` of shape :obj:`(batch_size * config.n_docs, config.max_combined_length)`, `optional`, returned when `output_retrieved=True`):
            Attention mask post-processed from the retrieved documents and the question encoder :obj:`input_ids` by the
            retriever.
        question_encoder_last_hidden_state (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length, hidden_size)`, `optional`):
            Sequence of hidden states at the output of the last layer of the question encoder pooled output of the
            model.
        question_enc_hidden_states (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_hidden_states=True`` is passed or when ``config.output_hidden_states=True``):
        ...
        question_enc_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`.

            Attentions weights of the question encoder, after the attention softmax, used to compute the weighted
            average in the self-attention heads.
        generator_enc_last_hidden_state (:obj:`mindspore.FloatTensor` of shape :obj:`(batch_size, sequence_length, hidden_size)`, `optional`):
            Sequence of hidden-states at the output of the last layer of the generator encoder of the model.
        generator_enc_hidden_states (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_hidden_states=True`` is passed or when ``config.output_hidden_states=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for the output of the embeddings and one for the output of each
            layer) of shape :obj:`(batch_size, sequence_length, hidden_size)`.

            Hidden states of the generator encoder at the output of each layer plus the initial embedding outputs.
        generator_enc_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`.

            Attentions weights of the generator encoder, after the attention softmax, used to compute the weighted
            average in the self-attention heads.
        generator_dec_hidden_states (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_hidden_states=True`` is passed or when ``config.output_hidden_states=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for the output of the embeddings and one for the output of each
            layer) of shape :obj:`(batch_size, sequence_length, hidden_size)`.

            Hidden states of the generator decoder at the output of each layer plus the initial embedding outputs.
        generator_dec_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`.

            Attentions weights of the generator decoder, after the attention softmax, used to compute the weighted
            average in the self-attention heads.
        generator_cross_attentions (:obj:`tuple(mindspore.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`mindspore.FloatTensor` (one for each layer) of shape :obj:`(batch_size, num_heads,
            sequence_length, sequence_length)`.
    ...
    doc_scores: mindspore.FloatTensor = None
    past_key_values: Optional[List[mindspore.FloatTensor]] = None
    retrieved_doc_embeds: Optional[mindspore.FloatTensor] = None
    retrieved_doc_ids: Optional[mindspore.LongTensor] = None
    context_input_ids: Optional[mindspore.LongTensor] = None
    context_attention_mask: Optional[mindspore.LongTensor] = None
    question_encoder_last_hidden_state: Optional[mindspore.FloatTensor] = None
    question_enc_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    question_enc_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    generator_enc_last_hidden_state: Optional[mindspore.FloatTensor] = None
    generator_enc_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    generator_enc_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    generator_dec_hidden_states: Optional[Tuple[mindspore.FloatTensor]] = None
    generator_dec_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
    generator_cross_attentions: Optional[Tuple[mindspore.FloatTensor]] = None
...
RAG_FORWARD_INPUTS_DOCSTRING = r"""
    Args:
        ...
        past_key_values (:obj:`tuple(tuple(mindspore.FloatTensor))`):
        ...
        if encoder_outputs is None:
            ...
            if has_to_retrieve:
                ...
                retriever_outputs = self.retriever(
                    input_ids,
                    question_encoder_last_hidden_state.cpu().detach().to(mindspore.float32).numpy(),
...
class RagSequenceForGeneration(RagPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        reduce_loss (:obj:`bool`, `optional`):
            ...
            ``mindspore.Tensor.sum`` operation.
        ...
        Example::
            ...
            >>> doc_scores = mindspore.bmm(question_hidden_states.unsqueeze(1), docs_dict["retrieved_doc_embeds"].float().transpose(1, 2)).squeeze(1)
    ...
    def generate(
        ...
        **model_kwargs
        ...
        Return:
            :obj:`mindspore.LongTensor` of shape :obj:`(batch_size * num_return_sequences, sequence_length)`: The generated
        ...
        if self.retriever is not None and context_input_ids is None:
            ...
            context_input_ids = self.retriever(
                input_ids,
                question_hidden_states.cpu().detach().to(mindspore.float32).numpy(),
                prefix=self.generator.config.prefix,
                n_docs=n_docs,
                return_tensors="pt",
            )["context_input_ids"]
        ...
        for index in range(batch_size):
            ...
            if do_deduplication:
                ...
                output_sequences = mindspore.stack(list({str(k.tolist()): k for k in output_sequences}.values()))
    ...
    def get_nll(
        ...
        seq_logprobs = mindspore.nn.functional.log_softmax(seq_logits, dim=-1).view(
            seq_logits.shape[0] // n_docs, n_docs, -1, seq_logits.size(-1)
        )  # batch_size x n_docs x tgt_len x #vocab_size
        doc_logprobs = mindspore.nn.functional.log_softmax(doc_scores, dim=1).unsqueeze(-1).unsqueeze(-1)

        # RAG-sequence marginalization
        first_token_scores = seq_logprobs[:, :, :1, :]
        second_token_scores = seq_logprobs[:, :, 1:2, :]
        remainder = seq_logprobs[:, :, 2:, :]
        rag_logprobs = mindspore.cat([first_token_scores, second_token_scores + doc_logprobs, remainder], dim=2)
...
class RagTokenForGeneration(RagPreTrainedModel):
    ...
    def marginalize(self, seq_logits, doc_scores, n_docs=None):
        ...
        doc_logprobs = mindspore.log_softmax(doc_scores, dim=1)
        log_prob_sum = seq_logprobs + doc_logprobs.unsqueeze(-1).unsqueeze(-1)
        return mindspore.logsumexp(log_prob_sum, dim=1)
    ...
    def forward(
        ...
        **kwargs  # needs kwargs for generation
        ...
        do_marginalize (:obj:`bool`, `optional`):
            ...
            ``mindspore.nn.functional.log_softmax``.
        reduce_loss (:obj:`bool`, `optional`):
            Only relevant if ``labels`` is passed. If :obj:`True`, the NLL loss is reduced using the
            ``mindspore.Tensor.sum`` operation.
        kwargs (:obj:`Dict[str, any]`, optional, defaults to `{}`):
    ...
    def generate(
        ...
        **model_kwargs
        ...
        if self.retriever is not None and context_input_ids is None:
            ...
            # compute doc_scores
            doc_scores = mindspore.bmm(question_hidden_states.unsqueeze(1), retrieved_doc_embeds.transpose(1, 2)).squeeze(
                1
            )
