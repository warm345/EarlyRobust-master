...
class TrainerCallback:
    ...
    Args:
        ...
        model (:class:`~transformers.PreTrainedModel` or :obj:`mindspore.nn.Module`):
            The model being trained.
        tokenizer (:class:`~transformers.PreTrainedTokenizer`):
            The tokenizer used for encoding the data.
        optimizer (:obj:`mindspore.optim.Optimizer`):
            The optimizer used for the training steps.
        lr_scheduler (:obj:`mindspore.optim.lr_scheduler.LambdaLR`):
            The scheduler used for setting the learning rate.
        train_dataloader (:obj:`mindspore.utils.data.dataloader.DataLoader`, `optional`):
            The current dataloader used for training.
        eval_dataloader (:obj:`mindspore.utils.data.dataloader.DataLoader`, `optional`):
            The current dataloader used for training.
