...
class StoppingCriteria(ABC):
    ...
    def __call__(self, input_ids: mindspore.LongTensor, score: mindspore.FloatTensor, **kwargs) -> bool:
...
class MaxLengthCriteria(StoppingCriteria):
    ...
    @add_start_docstrings(LOGITS_PROCESSOR_INPUTS_DOCSTRING)
    def __call__(self, input_ids: mindspore.LongTensor, scores: mindspore.FloatTensor, **kwargs) -> bool:
