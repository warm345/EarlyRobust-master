...
def convert_tf_checkpoint_to_mindspore(tf_hub_path, mindspore_dump_path, is_encoder_named_decoder, vocab_size, is_encoder):
    ...
    print("Save mindspore model and config to {}".format(mindspore_dump_path))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="If decoder has to be renamed to encoder in mindspore model.",
    )
