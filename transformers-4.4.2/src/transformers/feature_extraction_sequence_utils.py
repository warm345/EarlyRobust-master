...
class SequenceFeatureExtractor(FeatureExtractionMixin):
    ...
    def pad(
        ...
        .. note::
            ...
            If the ``processed_features`` passed are dictionary of numpy arrays, mindspore tensors or TensorFlow tensors,
            the result will use the same type unless you provide a different tensor type with ``return_tensors``. In
            the case of mindspore tensors, you will lose the specific device of your tensors however.
        ...
        Args:
            processed_features (:class:`~transformers.BatchFeature`, list of :class:`~transformers.BatchFeature`, :obj:`Dict[str, List[float]]`, :obj:`Dict[str, List[List[float]]` or :obj:`List[Dict[str, List[float]]]`):
                ...
                preprocessing as well as in a mindspore Dataloader collate function.

                Instead of :obj:`List[float]` you can have tensors (numpy arrays, mindspore tensors or TensorFlow
