...
class PretrainedConfig(object):
    ...
    Parameters for sequence generation
        ...
        - **return_dict_in_generate** (:obj:`bool`, `optional`, defaults to :obj:`False`) -- Whether the model should
          return a :class:`~transformers.file_utils.ModelOutput` instead of a :obj:`mindspore.LongTensor`
    ...
    Parameters for fine-tuning tasks
        ...
        - **finetuning_task** (:obj:`str`, `optional`) -- Name of the task used to fine-tune the model. This can be
          used when converting from an original (TensorFlow or mindspore) checkpoint.
    ...
    mindspore specific parameters
        ...
        - **mindsporescript** (:obj:`bool`, `optional`, defaults to :obj:`False`) -- Whether or not the model should be
          used with mindsporescript.
    ...
    def __init__(self, **kwargs):
        ...
        self.mindsporescript = kwargs.pop("mindsporescript", False)  # Only used by mindspore models
    ...
    def use_return_dict(self) -> bool:
        ...
        """
        # If mindsporescript is set, force `return_dict=False` to avoid jit errors
        return self.return_dict and not self.mindsporescript
